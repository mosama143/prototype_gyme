      ...
      <div className="max-w-md mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-white/5 border border-white/10 rounded-2xl p-8">
          ...
          <div className="text-right mb-6">
            <Link href="/forgot-password" className="text-sm text-[#84FF00] hover:text-[#84FF00]/80 transition-colors">
              Forgot Password?
            </Link>
          </div>
          ...
          <div className="text-center">
            <p className="text-gray-400">
              ...
              <Link href="/register" className="text-[#84FF00] hover:text-[#84FF00]/80 font-bold transition-colors">
                Sign Up
              </Link>
            </p>
          </div>
